...
function getGeneratedAttributeFromExtra(extra)
{
  if (!extra || !extra.includes('GENERATED'))
    return undefined;
  return {
    stored: extra.includes('STORED'),
    query: '', //No way to deduce query from extra
  }
}
  ...
  if (this.isSelectQuery()) {
    ...
    data.forEach(function(_result) {
      ...
      result[_result.Field] = {
        ...
        generated: getGeneratedAttributeFromExtra(_result.Extra),
      };
    });
